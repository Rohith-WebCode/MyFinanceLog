...
const {addTransaction,getTransactions,deleteTransaction,searchTransaction,getLastMonthTransactions,getAnalytics} = require ('../controllers/transactionController')
const protect = require('../middleware/protect')


Router.post('/transactions',protect,addTransaction)
Router.get('/transactions',protect,getTransactions)
Router.get('/analytics/yearly',protect,getAnalytics)
